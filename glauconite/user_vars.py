...
def program_info():
    ...
    """
    program_output = "\nGlauconiteFilter Version 1.0.1\n"
...
def multiprocess_handling(vars):
    ...
    if vars["multithread_mode"] == "mpi":
        # Avoid EOF error
        from glauconite.operators.convert_files.gypsum_dl.gypsum_dl.Parallelizer import (
            Parallelizer,
        )
        ...
        from glauconite.operators.convert_files.gypsum_dl.gypsum_dl.Parallelizer import Parallelizer
...
def make_complete_children_dict(purpose_of_object):
    ...
    if purpose_of_object == "filter":
        import glauconite.operators.filter.filter_classes.filter_children_classes
        from glauconite.operators.filter.filter_classes.parent_filter_class import ParentFilter as parent_object
